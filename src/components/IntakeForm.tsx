  ...
  const advisory = useMemo(
    () =>
      classify({
        ...
        typeAlwaysReview: selectedType
          ? selectedType.always_review
          : eventTypeId === 'other',
  ...
  function validate(index: number) {
    ...
    if (index === 0) {
      ...
      if (!departmentOrg.trim())
        e.departmentOrg = 'Enter your department or organization.';
    }
    if (index === 2) {
  ...
  if (reference) {
    return (
      <div className="card">
        ...
        <p className="hint">
          Keep this reference number &mdash; it identifies your request in any
          email or phone call.
        </p>
        <ol className="next-steps">
          <li>
            The events office reviews your request and confirms the
            classification. If anything is unclear, they will send you a question
          ...
          <li>
            Final headcount is locked shortly before the event, and the confirmed
            details are sent to everyone involved.
          </li>
        </ol>
        <button
      ...
      <div>
        <ol className="progress">
          {STEPS.map((s, i) => (
            <li
              key={s.name}
              data-state={i === step ? 'active' : i < furthest ? 'done' : ''}
            >
        ...
        {step === 0 && (
          <section className="card">
            ...
            <p className="hint">
              The basics. If your date or space is not settled yet, give your best
              estimate &mdash; we confirm availability before anything is booked.
            </p>

            <div className="field">
              <label htmlFor="eventTypeId">
                What kind of event is this?<span className="req">*</span>
              </label>
              <p className="sub">
                Pick the closest match. This is the single most useful thing you
                can tell us &mdash; most classifications are already decided for
                common event types.
              </p>
              <select
                id="eventTypeId"
              ...
              >
                ...
                <option value="other">Something else &mdash; not listed here</option>
              </select>
              {err('eventTypeId')}
            ...
            <div className="field">
              <label htmlFor="eventPurpose">
                Event purpose<span className="req">*</span>
              </label>
              <p className="sub">
                What is the event for, and who is it for? A sentence or two is
                plenty.
              </p>
              <textarea
                id="eventPurpose"
            ...
            <div className="grid two">
              ...
              <div className="field">
                <label htmlFor="estimatedAttendance">
                  Estimated attendance<span className="req">*</span>
                </label>
                <input
            ...
            <div className="field">
              <label htmlFor="spaceId">
                Location requested<span className="req">*</span>
              </label>
              <select
                id="spaceId"
                value={spaceId}
              ...
              {spaceId === 'other' && (
                <div className="conditional on">
                  <label htmlFor="locationFreetext">
                    Describe the location you have in mind
                  </label>
                  <input
                    id="locationFreetext"
                    type="text"
        ...
        {step === 1 && (
          <section className="card">
            ...
            <p className="hint">
              What you would like us to provide. Nothing here is final &mdash; you
          ...
          <section className="card">
            ...
            <fieldset className="field">
              <span className="legend">
                Is an outside organization involved?<span className="req">*</span>
              </span>
              <p className="sub">
                Any group, business, or partner that is not part of Central College.
              </p>
              ...
              {outsideOrgInvolved === 'yes' && (
                <div className="conditional on">
                  <label htmlFor="outsideOrgName">
                    Name of the outside organization
                  </label>
                  <input
                    id="outsideOrgName"
                    type="text"
            ...
            <fieldset className="field">
              <span className="legend">
                Is there outside funding, a grant, or sponsorship?
              ...
              {outsideFunding === 'yes' && (
                <div className="conditional on">
                  <label htmlFor="outsideFundingDetail">
                    Describe the funding source
                  </label>
                  <input
                    id="outsideFundingDetail"
                    type="text"
            ...
            <fieldset className="field">
              <span className="legend">
                Will registration, admission, or other revenue be collected?
                <span className="req">*</span>
              </span>
            ...
            <fieldset className="field">
              <span className="legend">
                Who assumes the financial risk?<span className="req">*</span>
              </span>
              <p className="sub">
                If the event loses money or is cancelled late, who absorbs the cost?
              </p>
              {radios('financialRisk', financialRisk, setFinancialRisk, [
                ['central', 'Central College'],
                ['shared', 'Shared'],
                ['outside', 'The outside party'],
                ['unclear', 'Not sure'],
              ])}
              {err('financialRisk')}
            </fieldset>
        ...
        {step === 3 && (
          <section className="card">
            ...
            <p className="hint">
              ...
              them as plainly as you can &mdash; &ldquo;not sure&rdquo; is a valid
              answer and simply routes your request for a closer look.
            </p>

            <fieldset className="field">
              <span className="legend">
                Is this official Central College business?<span className="req">*</span>
              </span>
            ...
            <fieldset className="field">
              <span className="legend">
                Who owns and controls the event?<span className="req">*</span>
              </span>
              <p className="sub">
                Who decides the program, the guest list, and how it runs.
              </p>
            ...
            <fieldset className="field">
              <span className="legend">
                Who primarily benefits?<span className="req">*</span>
              </span>
              {radios('primaryBeneficiary', primaryBeneficiary, setPrimaryBeneficiary, [
                ['central', 'Central'],
                ['shared', 'Both substantially'],
                ['outside', 'Outside party'],
                ['unclear', 'Not sure'],
              ])}
            ...
            <fieldset className="field">
              <span className="legend">
                Who primarily pays?<span className="req">*</span>
              </span>
        ...
        {step === 4 && (
          <section className="card">
            ...
            <p className="hint">
              ...
              your request and confirms the classification &mdash; you will hear
              back before anything is booked.
            </p>
            ...
            <ReviewGroup
              ...
              onEdit={() => go(0)}
              rows={[
                ['Event type', selectedType?.name ?? eventTypeOther],
                ...
                [
                  'Location',
                  spaces.find((s) => s.id === spaceId)?.name ?? locationFreetext,
                ],
            ...
            <ReviewGroup
              ...
              rows={[
                ...
                [
                  ...
                  outsideOrgInvolved === 'yes' ? outsideOrgName || 'Yes' : 'No',
                ],
                ['Outside funding', PARTY_LABEL[outsideFunding] ?? ''],
                [
                  'Revenue collected',
                  revenueCollected === 'yes' ? `Yes - to ${revenueRecipient}` : 'No',
                ],
          ...
          {advisory.classification ? (
            <>
              ...
              <ul className="reasons">
                {advisory.reasons.slice(0, 6).map((r, i) => (
                  <li key={i}>{r}</li>
                ))}
              </ul>
            </>
